...
class EditLostPet extends StatefulWidget {
  final String lostPetId;

  const EditLostPet({required this.lostPetId});

  @override
  _EditLostPetState createState() => _EditLostPetState();
}

class _EditLostPetState extends State<EditLostPet> {
  //Variables
  ...
  getPet() async {
    ...
    mediaUrl = lostPetResult!.mediaUrl;
    namePetController.text = lostPetResult!.name;
    agePetController.text = lostPetResult!.age.toString();
    emailController.text = lostPetResult!.email;
    numberPhoneController.text = lostPetResult!.numberPhone.toString();
    if (numberPhoneController.text == "0") {
      numberPhoneController.text = "";
    }
    petBreedController.text = lostPetResult!.petBreed;
    locationController.text = lostPetResult!.location;
    descriptionController.text = lostPetResult!.description;
    genderValue = lostPetResult!.gender;
    typeValue = lostPetResult!.type;
    numberChipController.text = lostPetResult!.numberChip;
    provinceValue = lostPetResult!.province;
  ...
  updateLostPet() async {
    ...
    setState(() {
      lostPetsRef.doc(lostPetResult!.id).update({
  ...
  deleteLostPet(BuildContext parentContext) async {
    return showDialog(
  ...
  delete() {
    lostPetsRef.doc(lostPetResult!.id).get().then((doc) {
      if (doc.exists) {
