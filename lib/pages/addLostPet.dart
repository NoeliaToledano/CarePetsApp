...
class AddLostPet extends StatefulWidget {
  @override
  _AddLostPetState createState() => _AddLostPetState();
}

class _AddLostPetState extends State<AddLostPet> {
  //Variables
  ...
  String lostPetId = const Uuid().v4();
  String patronCorreo =
  ...
  addPet({required String mediaUrl}) async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("Mascota perdida añadida")));
    }
  }
